      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 md:p-6 relative overflow-hidden">
        ...
        <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-6 md:p-8 relative z-10">
          ...
          <form onSubmit={handleLogin} className="space-y-5 md:space-y-6">
            ...
            <button type="submit" className="w-full bg-blue-600 text-white font-bold py-3 md:py-3.5 rounded-lg hover:bg-blue-700 transition shadow-md text-sm md:text-base">
              Access Portal
            </button>
          </form>
      ...
      <main className="max-w-4xl mx-auto px-4 mt-6 md:mt-8">
        <form onSubmit={handleSubmitForm} className="space-y-6 md:space-y-8">
          ...
          <div className="bg-white p-5 md:p-8 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-6">
              <div className="md:col-span-2">
                <label htmlFor="previousSchool" className="block text-xs md:text-sm font-semibold text-gray-700 mb-1.5 md:mb-2">Last School Attended</label>
              ...
              <div>
                <label htmlFor="jambScore" className="block text-xs md:text-sm font-semibold text-gray-700 mb-1.5 md:mb-2">JAMB Score (if applicable)</label>
                <input id="jambScore" name="jambScore" type="number" value={formData.jambScore} onChange={handleInputChange} className="w-full p-2.5 md:p-3 text-sm md:text-base bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition-all" />
              </div>
              <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2 md:pt-4">
            ...
            <button 
              type="submit" 
              className="flex-1 bg-blue-600 text-white font-bold py-3 md:py-4 rounded-lg hover:bg-blue-700 transition shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-sm md:text-base"
            >
              Submit Final Application <Send className="w-4 h-4 md:w-5 md:h-5" />
            </button>
          </div>
