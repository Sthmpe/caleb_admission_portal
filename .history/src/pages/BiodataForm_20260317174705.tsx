      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4 md:p-6">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-6 md:p-8 text-center border-t-4 border-green-500">
          ...
          <p className="text-sm md:text-base text-gray-600 mb-5 md:mb-6 border-b pb-5 md:pb-6">
            Your biodata for PIN <strong className="font-mono text-blue-600">{pin}</strong> has been submitted successfully. 
          </p>

          {/* REDIRECT TO THE SECURE EDITOR */}
          <Link 
            to={`/editor?pin=${pin.toUpperCase()}`} 
            className="w-full bg-slate-900 text-white font-bold py-3 md:py-3.5 rounded-lg hover:bg-black transition flex items-center justify-center gap-2 mb-3 shadow-md text-sm md:text-base"
          >
            <Printer className="w-4 h-4 md:w-5 md:h-5" /> Review & Print Official Form
          </Link>
