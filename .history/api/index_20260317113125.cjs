...
// POST: Generate a new Agent Code
app.post('/api/agents', async (req, res) => {
  try {
    ...
    // Save to Firestore using the code as the Document ID for easy lookup later
