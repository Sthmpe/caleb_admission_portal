...
const Home = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-gray-50 overflow-x-hidden">
      ...
      {/* Navbar */}
      <nav className="bg-white shadow-sm py-3 md:py-4 px-4 md:px-8 flex justify-between items-center sticky top-0 z-50">
        <div className="flex items-center gap-3">
          <div className="h-8 md:h-12 overflow-hidden flex items-center justify-center">
      ...
      <header className="bg-slate-900 text-white py-10 md:py-20 px-4 md:px-6 relative overflow-hidden flex-grow flex items-center">
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-12 items-center relative z-10 w-full">
          
          {/* Text Content */}
          <div className="text-center lg:text-left">
            <div className="inline-block bg-blue-800/50 border border-blue-700 rounded-full px-3 md:px-4 py-1.5 mb-4 md:mb-6">
              <span className="text-[10px] md:text-sm font-semibold text-blue-200 uppercase tracking-wider">
                Application Portal
              </span>
            </div>
            ...
            <div className="hidden lg:flex flex-col gap-4 text-slate-200 mt-8 text-sm">
              <div className="flex items-center gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-xs font-bold shrink-0">1</span>
                Pay the ₦10,000 application fee online.
              </div>
              <div className="flex items-center gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-xs font-bold shrink-0">2</span>
                Receive your secure Application PIN.
              </div>
              <div className="flex items-center gap-3">
                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-600 text-xs font-bold shrink-0">3</span>
          ...
          <div className="w-full max-w-md mx-auto lg:ml-auto">
            <div className="bg-white text-gray-900 p-6 md:p-8 rounded-2xl shadow-2xl border-t-4 border-blue-600 mx-2 md:mx-0">
              <h2 className="text-lg md:text-xl font-bold mb-5 md:mb-6 text-center text-gray-800 border-b pb-4">
                Application Status
              </h2>
              ...
              {settings.status === 'open' && (
                <div className="text-center">
                  <div className="flex justify-center mb-4">
                    <span className="flex items-center gap-2 bg-green-100 text-green-800 px-3 md:px-4 py-1.5 md:py-2 rounded-full font-bold text-xs md:text-sm">
                      <span className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-green-500 animate-pulse"></span>
                      Portal is currently OPEN
                    </span>
                  </div>
                  <p className="text-xs md:text-sm text-gray-600 mb-5 md:mb-6 px-2">
                    Application forms are currently available for purchase.
                  </p>
                  
                  <Link 
                    to="/apply" 
                    className="flex items-center justify-center gap-2 w-full bg-blue-600 text-white font-bold py-3 md:py-4 px-4 md:px-6 rounded-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 mb-2 text-sm md:text-base"
                  >
                  ...
                  <div className="pt-4 md:pt-5 border-t border-gray-100">
                    <p className="text-xs md:text-sm font-semibold text-gray-700 mb-2 md:mb-3">Already have an Application PIN?</p>
                    <Link 
                      to="/biodata" 
                      className="flex items-center justify-center gap-2 w-full bg-white text-blue-700 border-2 border-blue-600 font-bold py-2.5 md:py-3 px-4 md:px-6 rounded-lg hover:bg-blue-50 transition-all text-sm md:text-base"
                    >
                      <Lock className="w-3.5 h-3.5 md:w-4 md:h-4" /> Continue Biodata
                    </Link>
                  </div>
                </div>
              )}
              ...
              {settings.status === 'coming_soon' && (
                <div className="text-center">
                  <p className="text-yellow-600 font-bold mb-2 text-base md:text-lg">
      ...
      <section className="py-10 md:py-12 bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-4 md:gap-8 text-center md:divide-x md:divide-gray-100">
            <div className="px-2 md:px-4">
              <p className="text-2xl md:text-4xl font-extrabold text-blue-900 mb-1">
                <AnimatedCounter target={15} suffix="+" />
              </p>
              <p className="text-[10px] md:text-sm font-semibold text-gray-500 uppercase tracking-wide">Years of Excellence</p>
            </div>
            <div className="px-2 md:px-4">
              <p className="text-2xl md:text-4xl font-extrabold text-blue-900 mb-1">
                <AnimatedCounter target={40} suffix="+" />
              </p>
              <p className="text-[10px] md:text-sm font-semibold text-gray-500 uppercase tracking-wide">Programs Offered</p>
            </div>
            <div className="px-2 md:px-4">
              <p className="text-2xl md:text-4xl font-extrabold text-blue-900 mb-1">
                <AnimatedCounter target={10} suffix=",000+" />
              </p>
              <p className="text-[10px] md:text-sm font-semibold text-gray-500 uppercase tracking-wide">Graduates Worldwide</p>
            </div>
            <div className="px-2 md:px-4">
              <p className="text-2xl md:text-4xl font-extrabold text-blue-900 mb-1">
                <AnimatedCounter target={30} suffix="+" />
              </p>
              <p className="text-[10px] md:text-sm font-semibold text-gray-500 uppercase tracking-wide">Global Lecturers</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer id="contact" className="bg-slate-900 text-slate-300 py-10 md:py-12 border-t-[6px] border-blue-600">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
          
          {/* Brand Column */}
          <div>
            <div className="h-10 md:h-12 bg-white p-2 rounded inline-flex items-center justify-center mb-4">
          ...
          <div className="md:col-span-2">
            <h3 className="text-base md:text-lg font-bold text-white mb-6 uppercase tracking-wider">Contact Us</h3>
            <div className="grid sm:grid-cols-2 gap-8 md:gap-6 text-sm text-slate-400">
