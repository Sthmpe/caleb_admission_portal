              ...
              {settings.status === 'open' && (
                <div className="mt-4 pt-4 border-t border-green-200">
                  <p className="text-sm font-bold text-green-800 mb-3 flex items-center gap-2">
                    <BookOpen className="w-4 h-4" /> Select which programs are active:
                  </p>
                  <div className="grid sm:grid-cols-3 gap-3">
                    <label className="flex items-center gap-2 bg-white p-2 rounded border border-green-200 cursor-pointer hover:bg-green-100 transition">
